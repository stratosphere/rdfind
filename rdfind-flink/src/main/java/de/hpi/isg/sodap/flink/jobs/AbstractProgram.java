 ...
 */
public abstract class AbstractProgram<TParameters> {
    ...
    /**
     * Creates a new {@link AbstractProgram} instance.
     * 
     * @param args
     *        are, e.g., command line parameters to configure this program.
     */
    public AbstractProgram(final String... args) {
     ...
     * 
     * @param args
     *        are the same parameters as in the constructor {@link #AbstractProgram(String...)}.
     */
